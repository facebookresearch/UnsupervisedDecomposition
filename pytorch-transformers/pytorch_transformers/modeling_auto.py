...
from .modeling_roberta import RobertaConfig, RobertaModel, RobertaForMaskedLM, RobertaForSequenceClassification, RobertaForQuestionAnswering
...
class AutoModelForQuestionAnswering(object):
    r"""
        ...
        in the `pretrained_model_name_or_path` string (in the following order):
            ...
            - contains `roberta`: RobertaForQuestionAnswering (RoBERTa model)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if 'distilbert' in pretrained_model_name_or_path:
            ...
            return RobertaForQuestionAnswering.from_pretrained(pretrained_model_name_or_path, *model_args, **kwargs)
        elif 'bert' in pretrained_model_name_or_path:
